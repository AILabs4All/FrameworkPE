...
class TokenMetrics:
    """Coleta e armazena métricas de tokens por interação com o modelo."""
    ...
    def log_interaction(self, model_name: str, mode: str,
    ...
    def _save_to_file(self, interaction: dict, model_name: str, mode: str):
        """Persiste interação em arquivo JSON."""
    ...
    def get_session_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "models_used": list({i["model_name"] for i in self.interactions}),
            "modes_used": list({i["mode"] for i in self.interactions}),
...
class MetricsCollector:
    """Coleta métricas de performance do processo (tempo e memória)."""
    ...
    def log_performance_summary(self) -> Dict[str, Any]:
        """Retorna e loga resumo de performance."""
        summary = {
